                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex gap-2 my-1  justify-content-center align-items-center">
                            ...
                            <span class="delete-btn" data-bs-toggle="modal" data-bs-target="#modal-{{ $tecnology->id }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button tecnology="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
